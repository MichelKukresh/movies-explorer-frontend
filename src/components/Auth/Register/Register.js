  ...
  return(
    <div className="register">
      ...
      <form className="register__form-container">
        ...
        <input type="text" className="register__input-type" placeholder="Василий"></input>
        <span className="register__span-input register__span-input_validation">Валидация</span>
        <span className="register__span-input">E-mail</span>
        <input type="text" className="register__input-type" placeholder="pochta@yandex.ru"></input>
        <span className="register__span-input register__span-input_validation">Валидация</span>
        <span className="register__span-input">Пароль</span>
        <input type="password" className="register__input-type" placeholder="11111111"></input>
        <span className="register__span-input register__span-input_validation">Валидация</span>
      ...
      <div className="register__wrapper-is-register">
          ...
          <Link to="/sign-in" className="register__in">Войти</Link>
        </div>
