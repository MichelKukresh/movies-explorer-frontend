  ...
  return(
    <div className="login">
      ...
      <form className="login__form-container">
        ...
        <input type="text" className="login__input-type" placeholder="pochta@yandex.ru"></input>
        <span className="login__span-input login__span-input_validation">Валидация</span>
        <span className="login__span-input">Пароль</span>
        <input type="password" className="login__input-type" placeholder="11111111"></input>
        <span className="login__span-input login__span-input_validation">Валидация</span>
        <button
      ...
      <div className="login__wrapper-is-login">
          ...
          <Link to="/sign-up" className="login__in">Регистрация</Link>
        </div>
